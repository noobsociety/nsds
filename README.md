...
Reusable design tokens, CSS primitives, Tailwind preset, MUI theme, and pixel-art React components for NoobSociety.
...
import { NSThemeProvider, theme } from '@noobsociety/nsds/mui';
```
...
| `@noobsociety/nsds/mui` | Optional MUI theme runtime and types |
...
| `mui-theme/` | Public source | Optional MUI theme entry |
